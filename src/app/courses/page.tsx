    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <main className="flex-1">
            ...
            >
              ...
              <div className="relative h-36 bg-gray-100 overflow-hidden">
                ...
                {course.certification && (
                  <div className="absolute top-1.5 right-1.5 bg-[#5DCCDB] text-white px-1.5 py-0.5 rounded text-[10px] font-bold flex items-center gap-1">
              ...
              {/* Course Content */}
              <div className="p-3">
                <h3 className="text-base font-bold text-gray-800 mb-1.5 group-hover:text-[#5DCCDB] transition">
                  {course.title}
                </h3>
                ...
                <div className="flex items-center gap-2.5 text-[11px] text-gray-500 mb-2.5">
                  <div className="flex items-center gap-1">
                    <FaClock className="text-[#5DCCDB] text-[10px]" />
                    {course.duration}
                  </div>
                  <div className="flex items-center gap-1">
                    <FaUsers className="text-[#5DCCDB] text-[10px]" />
                ...
                <button
                  ...
                  className="w-full px-3 py-1.5 bg-[#5DCCDB] text-white text-xs font-semibold rounded hover:bg-[#5DCCDB] transition flex items-center justify-center gap-1.5"
                >
                  Enroll Now
        ...
        <div className="mt-6 bg-white border border-gray-200 rounded-lg p-4 max-w-xl">
          ...
          <button className="px-3 py-1.5 bg-[#5DCCDB] text-white text-xs font-semibold rounded hover:bg-[#5DCCDB] transition">
            Contact Support
          </button>
        </div>
      </div>
