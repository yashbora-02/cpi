  ...
  return (
    <div className="space-y-6">
                  ...
                  <td className="border px-4 py-3">
                    <div className="flex gap-2">
                      <button
                        ...
                        className="flex items-center gap-1 px-3 py-1.5 bg-[#2583F5] text-white rounded hover:bg-[#1a6ad9] transition-colors text-xs font-medium"
                      >
                        <FaEye /> View
                      </button>
                      <button
      ...
      <div className="flex flex-col sm:flex-row gap-3 justify-between">
        ...
        <button
          onClick={onCreateNew}
          className="flex items-center justify-center gap-2 px-5 py-2.5 bg-[#2583F5] text-white rounded-lg hover:shadow-lg transition-all font-medium text-sm"
        >
