      ...
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-lg mx-4 overflow-hidden transform transition-all animate-slideUp">
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
              <div className="flex items-start gap-3">
                <a
                  ...
                  className="flex-1 text-[#5DCCDB] hover:text-[#5DCCDB] break-all text-sm font-mono transition-colors"
                >
                  {link}
                </a>
                <button
        ...
        <div className="bg-gray-50 px-6 py-4 flex flex-col sm:flex-row gap-3 border-t border-gray-200">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex-1 px-6 py-2.5 rounded-lg font-medium text-sm shadow-md hover:shadow-lg transition-all duration-200 flex items-center justify-center gap-2 bg-[#2583F5] text-white hover:from-[#5DCCDB] hover:to-[#5DCCDB] transform hover:scale-105 active:scale-95"
          >
            <FaExternalLinkAlt />
            <span>Open Link</span>
          </a>
