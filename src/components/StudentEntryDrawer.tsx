          ...
          <div className="px-8 py-8 bg-white">
            ...
            <div className="mb-6 p-5 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border-2 border-blue-300 shadow-sm">
              <div className="flex items-center justify-between gap-4">
                ...
                <button
                  ...
                  className="bg-[#2583F5] text-white px-6 py-3 rounded-lg hover:shadow-lg transition-all duration-200 font-semibold text-sm flex items-center gap-2 transform hover:scale-[1.02] active:scale-95 flex-shrink-0"
                >
                  <FaDownload />
                  Download Sample CSV
                </button>
            ...
            <div
              className={`border-2 border-dashed rounded-xl p-12 text-center transition-all duration-300 ${
                isDragging
                  ? 'border-[#5DCCDB] bg-[#5DCCDB]/5 scale-[1.01]'
                  : 'border-gray-300 hover:border-[#5DCCDB]/50'
              }`}
            ...
            >
              <div className={`inline-block p-5 rounded-full mb-5 transition-all duration-300 ${
                isDragging ? 'bg-[#5DCCDB]/10 scale-110' : 'bg-gray-50'
              }`}>
                <FaCloudUploadAlt className={`text-5xl transition-all duration-300 ${
                  isDragging ? 'text-[#5DCCDB] animate-bounce' : 'text-gray-400'
                }`} />
              </div>
              ...
              <div className="flex justify-center">
                ...
                <label
                  htmlFor="csv-upload"
                  className="bg-[#2583F5] text-white px-8 py-3 rounded-lg cursor-pointer hover:shadow-lg flex items-center gap-2.5 transition-all transform hover:scale-[1.02] font-medium text-sm"
                >
                  <FaUpload />
                  Choose CSV File
                </label>
            ...
            {isProcessing && (
              <div className="mt-4 bg-blue-50 border border-blue-200 rounded-lg p-4 flex items-center gap-3">
                <div className="flex-shrink-0">
                  <div className="animate-spin rounded-full h-5 w-5 border-2 border-blue-200 border-t-[#5DCCDB]"></div>
                </div>
            ...
            {uploadSuccess && !isProcessing && (
              <div className="mt-4 bg-green-50 border border-green-200 rounded-lg p-4 flex items-start gap-3">
                <div className="flex-shrink-0 w-5 h-5 bg-[#5DCCDB] rounded-full flex items-center justify-center">
                  <span className="text-white text-xs font-bold">✓</span>
                </div>
          ...
          <div className="px-8 py-8 bg-gradient-to-b from-white to-gray-50">
            ...
            <div className="space-y-3">
              {students.map((student, idx) => (
                <div
                  key={idx}
                  className="grid grid-cols-1 md:grid-cols-[auto_1fr_1fr_1fr] gap-3 items-center p-4 bg-white rounded-xl hover:shadow-md transition-all border border-gray-200 hover:border-[#5DCCDB]"
                >
                  ...
                  <input
                    ...
                    className="border border-gray-300 p-3 rounded-lg text-gray-800 focus:ring-2 focus:ring-[#5DCCDB] focus:border-transparent transition-all bg-gray-50 focus:bg-white"
            ...
            <div className="flex justify-end items-center mt-6 pt-4 border-t border-gray-200">
              <button
                onClick={handleSave}
                className="bg-[#2583F5] text-white px-5 py-2 rounded-lg hover:shadow-lg flex items-center gap-2 transition-all font-medium text-sm"
              >
                <FaUserPlus />
                Save Students
              </button>
          ...
          <div className="px-8 py-6 bg-gray-50 border-t border-gray-200">
                    ...
                    <div className="overflow-hidden rounded-lg border border-gray-200 bg-white">
                      <div className="overflow-x-auto max-h-80">
                        <table className="min-w-full">
                          <thead className="bg-[#2583F5] text-white sticky top-0">
                            <tr>
            ...
            <div className="flex justify-end items-center mt-6 pt-4 border-t border-gray-200">
              <button
                ...
                className="bg-[#2583F5] text-white px-8 py-2.5 rounded-lg hover:shadow-lg flex items-center gap-2 transition-all font-medium text-sm disabled:from-gray-300 disabled:to-gray-400 disabled:cursor-not-allowed disabled:opacity-60"
              >
                <FaUserPlus />
                Save Students
              </button>
