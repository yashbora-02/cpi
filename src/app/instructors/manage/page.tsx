        ...
        <div className="bg-white p-4 rounded shadow max-w-6xl">
          <div className="mb-4 mb-4 flex justify-between items-center flex-wrap">
            ...
            <button
              ...
              className="bg-[#2583F5] text-white px-5 py-2 rounded-lg hover:shadow-lg transition-all font-medium text-sm mt-2 md:mt-0"
            >
              + Add Instructor
            </button>
          </div>
          ...
          <button
            ...
            className="mb-4 bg-[#2583F5] text-white px-5 py-2 rounded-lg hover:shadow-lg transition-all font-medium text-sm"
          >
            Search Instructors
          </button>
